...
let s:dein_rc_path = '~/.config/nvim/vimrc.d/plugins'
...
call dein#load_toml('~/.config/nvim/vimrc.d/dein/plugins.toml', {'lazy': 0})
call dein#load_toml('~/.config/nvim/vimrc.d/dein/plugins-lazy.toml', {'lazy': 1})
call dein#end()
